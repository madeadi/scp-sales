...
export const taxes = state => Math.round(subtotal(state) * 0.07, 2)
...
//   }
// }
export const shipping = () => { return 0 }
...
export const currency = state => {
  return state.shoppingCart.currency
}

export const loginModal = state => {
  return state.login.loginVisible
}
